...
import SingleProjectContext from '../contexts/SingleProject-context';
// src/assets/components/Project/Project-info.jsx
export default function ProjectInfo({ singleProjectData, darkMode }) {
  if (!singleProjectData || !singleProjectData.ProjectInfo) {
    return null; // or a placeholder
  }

  const info = singleProjectData.ProjectInfo;
  ...
  return (
   <div className="block sm:flex gap-0 sm:gap-10 mt-14">
			<div className="w-full sm:w-1/3 text-left">
				...
				<div className="mb-7">
					<p className="font-general-regular text-2xl font-semibold text-ternary-dark dark:text-ternary-light mb-2">
						{singleProjectData.ProjectInfo.Technologies[0].title || 'No Title Available'}
					</p>
					<p className="font-general-regular text-primary-dark dark:text-ternary-light">
