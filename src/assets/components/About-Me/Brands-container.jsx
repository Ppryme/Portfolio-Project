...
export default function Brands() {
    return (
        ...
        <section className=" gap-6 max-w-6xl mx-auto  grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2     ">
           ...
           { clientsData.map( (brands) =>  <div className="mx-auto flex-nowrap"> < img className="sm:w-54 w-44 shadow-sm bg-white " src= {brands.img} alt={brands.title} key={brands.id} /> </div>)} 
